...
wget http://mirror.centos.org/centos/7.6.1810/updates/x86_64/Packages/kernel-3.10.0-957.1.3.el7.x86_64.rpm
wget http://mirror.centos.org/centos/7.6.1810/updates/x86_64/Packages/kernel-devel-3.10.0-957.1.3.el7.x86_64.rpm
wget http://mirror.centos.org/centos/7.6.1810/updates/x86_64/Packages/kernel-headers-3.10.0-957.1.3.el7.x86_64.rpm
yum -y install yum-plugin-versionlock
yum install -y kernel-3.10.0-957.1.3.el7.x86_64.rpm kernel-devel-3.10.0-957.1.3.el7.x86_64.rpm kernel-headers-3.10.0-957.1.3.el7.x86_64.rpm
yum versionlock kernel-headers-3.10.0-957.1.3.el7.x86_64.rpm
